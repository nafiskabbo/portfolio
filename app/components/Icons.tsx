...
export const SwiftIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M22.186 16.35c-.156-.37-.775-1.554-2.126-2.613a17.41 17.41 0 00-2.83-1.84s1.233-.064 1.838-.112a4.91 4.91 0 001.373-.242 5.093 5.093 0 001.334-.734s-.474.37-1.162.585c-.689.214-1.63.385-2.09.428-.46.042-1.353-.057-2.903-.784-1.549-.727-2.639-2.261-2.766-4.045-.128-1.784.028-2.426.028-2.426s-.92.834-1.686 2.585c-.767 1.752-1.071 3.224-.614 4.8-.458 2.05-.286 4.352-.286 4.352s-1.834-1.87-2.87-4.225c-1.036-2.356-1.503-6.61s1.396-8.528 1.396-8.528A13.82 13.82 0 007.82.915a13.43 13.43 0 00-2.235.914 16.591 16.591 0 00-2.091 1.284 15.655 15.655 0 00-2.483 2.19c.142-.214.5-.728 1.106-1.127.606-.399 1.149-.57 1.506-.642-.258.114-.645.342-1.291.884-.646.543-1.134 1.099-1.392 1.485.459-.9 1.149-1.714 2.134-2.485C6.347 1.343 8.169.601 10.334.33 7.643.515 5.23 1.586 3.09 3.513c-2.14 1.927-3.08 4.295-3.08 6.906 0 2.612.926 5.672 3.864 8.799 2.938 3.127 6.36 4.704 9.4 4.78.332.008.665.011.996.002h.165a25.8 25.8 0 001.374-.158c3.086 0 6.643-1.527 8.536-2.798-.44.028-.88.042-1.319.042-1.101 0-2.049-.071-2.839-.214a7.99 7.99 0 00-2.185-.157c-.77.014-2.227.143-2.227.143s1.264-1.114 2.186-2.355c.922-1.242 1.353-2.155 1.353-2.155s1.942 1.885 3.974 2.913z" fill="#F05138" />
  </svg>
);
...
export const NodeIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2L4.5 6.33V17.67L12 22L19.5 17.67V6.33L12 2ZM6 16.8V7.2L12 3.74V7.2H18V16.8L12 20.26V16.8H6Z" fill="#339933" />
    <path d="M11 15H8V9H11V10.2L9.5 10.2V13.8L11 13.8V15Z" fill="#339933" />
    <path d="M16 11.4H14V12.6H16V13.8H14V15H13V9H16V10.2H14V11.4H16V11.4Z" fill="#339933" />
  </svg>
);
...
export const NextJsIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm0 1.5c5.8 0 10.5 4.7 10.5 10.5 0 .9-.1 1.8-.3 2.6L8.8 3.5c1-1 2.4-2 3.2-2zm-12 10.5c0-1.7.4-3.3 1.1-4.7L18.1 22.3h-4.6l-8.4-10.9v10.1h-4.1V12zM15.4 17.5h4.1V12c0-1.7-1.4-3.1-3.1-3.1h-1v8.6z" />
  </svg>
);
...
export const UpworkIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
