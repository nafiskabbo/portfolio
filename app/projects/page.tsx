        ...
        <div className="relative z-10 section-container">
          ...
          >
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-8">
              <Link
                href="/"
                className="inline-flex w-fit items-center gap-2 px-3 py-1.5 rounded-full text-slate-400 hover:text-[var(--theme-primary)] transition-all group text-sm"
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto sm:max-w-md sm:flex-1 sm:justify-end">
                          ...
                          return (
                            <li key={cat.id} role="option" aria-selected={selected}>
                              <button
                                ...
                                style={{
                                  color: selected ? 'var(--theme-primary)' : 'rgb(203, 213, 225)',
                                  background: selected
